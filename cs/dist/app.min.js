...
function init() {
    ...
    albums.forEach(function(item, index) {
        var li = jQuery('<li>');
        var a = jQuery('<a href="albums.php?id=' + item.id + '&title=' + item.title + '" data-index="' + index + '">' + item.title + '</a>');
    ...
    artists.forEach(function(item, index) {
        var li = jQuery('<li>');
        var a = jQuery('<a href="artists.php?id=' + item.id + '&title=' + item.title + '" data-index="' + index + '">' + item.title + '</a>');
