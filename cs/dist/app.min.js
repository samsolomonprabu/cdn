...
function loadData() {
    ...
    if (page === 'index.php' || page === '') {
        ...
        genCategories(albums, 'albums.php', 'handleAlbumClick(event);', 'https://axyxjugztm.cloudimg.io/width/800/none/https://samsolomonprabu.github.io/cdn/albums/' + currentLanguage + '/');
        data = [];
        HTTP_GET['id'] && filterAlbum();
    } else if (page === 'artists.php') {
        genCategories(artists, 'artists.php', 'handleArtistClick(event);', 'https://axyxjugztm.cloudimg.io/width/800/none/https://samsolomonprabu.github.io/cdn/artists/' + currentLanguage + '/');
        data = [];
        HTTP_GET['id'] && filterArtist();
    } else if (page === 'genres.php') {
        genCategories(genres, 'genres.php', 'handleGenreClick(event);', 'https://axyxjugztm.cloudimg.io/width/800/none/https://samsolomonprabu.github.io/cdn/genres/' + currentLanguage + '/');
        data = [];
