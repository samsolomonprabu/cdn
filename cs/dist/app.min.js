...
function loadData() {
    ...
    if (page === 'index.php' || page === '') {
        ...
        genCategories(genres, 'genres.php', 'handleGenreClick(event);', 'https://aagjxwfhen.cloudimg.io/width/800/none/https://samsolomonprabu.github.io/cdn/genres/' + currentLanguage + '/');
        data = [];
